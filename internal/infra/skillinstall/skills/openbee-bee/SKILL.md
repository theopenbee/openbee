...
openbee ctl worker create --name <name> [--description <desc>] [--engine <engine>] [--department <id|name>] [--engine-extra-args <engine=args>]
openbee ctl worker update <id> [--name <name>] [--description <desc>] [--engine <engine>] [--engine-extra-args <engine=args>]
