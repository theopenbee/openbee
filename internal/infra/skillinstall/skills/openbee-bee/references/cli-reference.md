...
openbee ctl worker create --name <name> [--description <description>] [--constraints <constraints content>] [--work-dir <directory>] [--engine <engine>] [--department <id|name>] [--scopes <scopes>]
openbee ctl worker update <id> [--name <name>] [--description <description>] [--constraints <constraints>] [--engine <engine>] [--department <id|name>] [--scopes <scopes>]
