...
func (s *RPCServer) CallTool(ctx context.Context, name string, args json.RawMessage) (any, error) {
...
func (s *RPCServer) workerDisplayName(workerID string) string {
...
func (s *RPCServer) checkWorkerScope(ctx context.Context, toolName string) error {
...
func (s *RPCServer) beeCallTool(ctx context.Context, name string, args json.RawMessage) (any, error) {
...
func (s *RPCServer) toolListWorkers(ctx context.Context, args json.RawMessage) (any, error) {
	var params struct {
...
func (s *RPCServer) toolGetWorker(args json.RawMessage) (any, error) {
	var params struct {
		WorkerID string `json:"worker_id"`
	}
	if err := json.Unmarshal(args, &params); err != nil {
...
func (s *RPCServer) toolCreateWorker(args json.RawMessage) (any, error) {
	var params struct {
		Name             string `json:"name"`
		Description      string `json:"description"`
...
func (s *RPCServer) toolUpdateWorker(args json.RawMessage) (any, error) {
	var params struct {
		WorkerID      string  `json:"worker_id"`
		DepartmentIDs *string `json:"department_ids"`
...
func (s *RPCServer) toolDeleteWorker(args json.RawMessage) (any, error) {
	var params struct {
		WorkerID      string `json:"worker_id"`
...
func (s *RPCServer) toolCreateTask(ctx context.Context, args json.RawMessage) (any, error) {
	var params struct {
...
func (s *RPCServer) toolListTasks(ctx context.Context, args json.RawMessage) (any, error) {
	var params struct {
		MessageID  string `json:"message_id"`
...
func (s *RPCServer) finalizeCancelledExecution(ctx context.Context, executionID string) {
...
func (s *RPCServer) toolCancelTask(ctx context.Context, args json.RawMessage) (any, error) {
	var params struct {
		TaskID string `json:"task_id"`
	}
	if err := json.Unmarshal(args, &params); err != nil {
...
func (s *RPCServer) toolSendMessage(ctx context.Context, args json.RawMessage) (any, error) {
	var params struct {
		MessageID string `json:"message_id"`
...
func (s *RPCServer) toolClearSession(ctx context.Context, args json.RawMessage) (any, error) {
	var params struct {
		SessionKey string `json:"session_key"`
...
func (s *RPCServer) toolGetWorkerStatus(ctx context.Context, args json.RawMessage) (any, error) {
	var p struct {
		WorkerID string `json:"worker_id"`
	}
...
func (s *RPCServer) toolGetSystemOverview(ctx context.Context) (any, error) {
	// Worker counts
...
func (s *RPCServer) toolListBeeExecutions(args json.RawMessage) (any, error) {
	var p struct {
...
func (s *RPCServer) toolSaveConstraint(args json.RawMessage) (any, error) {
	var p struct {
...
func (s *RPCServer) toolGetConstraint(args json.RawMessage) (any, error) {
	var p struct {
		Scope string `json:"scope"`
		Key   string `json:"key"`
	}
...
func (s *RPCServer) toolDeleteConstraint(args json.RawMessage) (any, error) {
	var p struct {
		Scope string `json:"scope"`
		Key   string `json:"key"`
	}
...
func (s *RPCServer) toolListSessionContexts(ctx context.Context, args json.RawMessage) (any, error) {
	var params struct {
		SessionKey string `json:"session_key"`
	}
	if err := json.Unmarshal(args, &params); err != nil {
...
func (s *RPCServer) toolClearWorkerSession(ctx context.Context, args json.RawMessage) (any, error) {
	var params struct {
		SessionKey string `json:"session_key"`
		WorkerID   string `json:"worker_id"`
	}
...
func (s *RPCServer) toolListDepartments(_ json.RawMessage) (any, error) {
...
func (s *RPCServer) toolGetDepartment(args json.RawMessage) (any, error) {
	var params struct {
		ID string `json:"id"`
	}
	if err := json.Unmarshal(args, &params); err != nil {
...
func (s *RPCServer) toolCreateDepartment(args json.RawMessage) (any, error) {
	var params struct {
		Name      string `json:"name"`
...
func (s *RPCServer) toolUpdateDepartment(args json.RawMessage) (any, error) {
	var params struct {
		ID        string  `json:"id"`
		Name      *string `json:"name"`
		ParentID  *string `json:"parent_id"`
...
func (s *RPCServer) toolDeleteDepartment(args json.RawMessage) (any, error) {
	var params struct {
		ID string `json:"id"`
	}
	if err := json.Unmarshal(args, &params); err != nil {
...
func (s *RPCServer) resolveDepartmentID(idOrName string) (string, error) {
...
func (s *RPCServer) resolveDepartmentIDs(idOrNames []string) ([]string, error) {
	if len(idOrNames) == 0 {
		return nil, nil
	}
	all, err := s.departmentStore.ListAll()
...
func (s *RPCServer) applyWorkerDepartments(workerID, deptIDsParam string) error {
	var deptIDs []string
	if deptIDsParam != "" {
		var err error
...
func (s *RPCServer) listWorkersRecursive(idOrName string) ([]string, error) {
	all, err := s.departmentStore.ListAll()
	if err != nil {
		return nil, fmt.Errorf("list departments: %w", err)
	}
...
func (s *RPCServer) toolListMessages(ctx context.Context, args json.RawMessage) (any, error) {
	var params struct {
		SessionKey     string `json:"session_key"`
...
func (s *RPCServer) toolListOutboundMessages(ctx context.Context, args json.RawMessage) (any, error) {
	var params struct {
		SessionKey string `json:"session_key"`
		Platform   string `json:"platform"`
		Status     string `json:"status"`
...
func (s *RPCServer) toolListExecutions(ctx context.Context, args json.RawMessage) (any, error) {
	var params struct {
		WorkerID      string `json:"worker_id"`
